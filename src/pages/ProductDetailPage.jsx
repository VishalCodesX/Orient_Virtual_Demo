    ...
    >
      ...
      >
        ...
        {imageSrc ? (
          ...
          <div className="text-white p-8">No image available</div>
        )}
...
// ---- Brochure Button(s) ----
const ProductBrochureButtons = ({ brochureUrl }) =>
  brochureUrl ? (
      ...
      <div className="space-y-6">
        ...
        >
          <img
            src={
              product.image ||
              "https://via.placeholder.com/600x450?text=Product+Image"
            }
            alt={product.name}
        ...
        <div className="bg-blue-50 rounded-lg p-4">
          ...
          <p className="text-blue-600 text-sm">
            Click the image above to view in full-screen mode for detailed
            examination of all product features.
          </p>
        </div>
      </div>
      {/* Product Information */}
        ...
        <div>
          ...
          <div className="mb-8">
            ...
            <p className="text-sm text-gray-600 mt-2">
              Click to get detailed pricing and consultation
            </p>
          </div>
        </div>
        {/* Specifications */}
...
const RaptorProductDetail = ({ product }) => {
  ...
  // ---- Video Modal (minimal for brevity) ----
      ...
      <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-2 text-sm">
              <div className="flex items-center gap-2">
                ...
                <span className="text-green-700">
                  <strong>Advanced AR:</strong> Full 3D model with realistic placement
                </span>
              </div>
              <div className="flex items-center gap-2">
                <Eye size={14} className="text-blue-600" />
                <span className="text-green-700">
                  <strong>Room Preview:</strong> Quick camera overlay visualization
                </span>
              </div>
              <div className="flex items-center gap-2">
                <Play size={14} className="text-purple-600" />
                <span className="text-green-700">
                  <strong>Virtual Demo:</strong> Complete video walkthrough with features
                </span>
              </div>
            </div>
          </div>
        ...
        <div className="space-y-8">
          ...
          <div className="space-y-4">
            ...
            <div className="mt-4">
              <ProductBrochureButtons brochureUrl={product.brochureUrl} />
            </div>
          </div>
        </div>
      </div>
